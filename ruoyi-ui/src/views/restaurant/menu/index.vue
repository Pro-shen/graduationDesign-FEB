<template>
  <div class="app-container">
    ...
    <el-table v-if="refreshTable" v-loading="loading" :data="tMenuList" row-key="id" :default-expand-all="isExpandAll"
      ...
      <el-table-column prop="plateColor" label="盘子颜色" width="180"></el-table-column>
      <el-table-column prop="dishStock" label="菜品存量" width="180"></el-table-column>
      <el-table-column prop="dishUsed" label="菜品销量" width="180"></el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="盘子颜色" prop="roleSort">
          <el-input-number v-model="form.roleSort" controls-position="right" :min="0" />
        </el-form-item>
        <el-form-item label="菜品存量" prop="roleSort">
          <el-input-number v-model="form.roleSort" controls-position="right" :min="0" />
        </el-form-item>
      </el-form>
